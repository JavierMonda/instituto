...
window.onload = function alerta() {
	document.getElementById('error').className='alert alert-success alert-dismissable';
...
window.onload = function alerta() {
	document.getElementById('error').className='alert alert-success alert-dismissable';
	document.getElementById('error').innerHTML = 'Conexión exitosa! <button type=\"button\" class=\"close\" data-dismiss=\"alert\">X</button>';};
</script>";
